public class DailyWageUC8 {
	...
	public static int EmpWage(String company, int emp_Rate_Per_Hr, int num_Of_Working_Days, int max_Hrs_Month) {
	...
	public static void main(String[] args) {
		EmpWage("Reliance", 20, 30, 200);
		System.out.println("------------------");
		EmpWage("Dmart", 100, 25, 150);
	}
}	
